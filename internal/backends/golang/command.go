...
// discovery, and execution; the provenance probe (goVersionCmd) and the
// Windows job wrapper spawn on their own. Tests install it to pin that a
// refusal fired before any of these spawns.
