...
- **[retarget-clause-identity-collision](retarget-clause-identity-collision.md)** - retarget's global collision key omits the resolved clause, so valid distinct-clause claims block unrelated symbol moves; preserve genuine duplicate refusal. *Lands: awaiting triage*
