...
- **[knob-terse-clause-per-face](knob-terse-clause-per-face.md)** — one knob line serves both faces, so a rendered terse clause can carry the other face's prose. *Lands: user decision*
