...
- **[resolver-child-kill-orphans-owned-groups](resolver-child-kill-orphans-owned-groups.md)** — the served resolver child, killed outright by its client, leaves every group-isolated spawn it made alive (REQ-go-owned-processes). *Lands: cross-tool train chunk 223*
