...
- **[own-witnesses-observe-the-memo-store](own-witnesses-observe-the-memo-store.md)** — every engine-building witness of the tool's own corpus records gofresh's memo files as uncovered runtime inputs since 2026-09-06 and never serves, so the warm self-host check executes its long packages every run (51s → 45 min). *Lands: cross-tool train chunk 280*
