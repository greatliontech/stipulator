...
- **[scoped-check-gap-excused-stale](scoped-check-gap-excused-stale.md)** - scoped check counts outside scope-skipped witnesses as unexcused broken rows when their stale binding consent is already excused by a current gap. *Lands: awaiting triage*
