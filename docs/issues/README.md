...
- **[resolver-child-version-skew](resolver-child-version-skew.md)** — the resolver child is self-executed lazily with no version handshake; a replaced binary under a running server answers with zero-filled fields. *Lands: cross-tool train chunk 224*
