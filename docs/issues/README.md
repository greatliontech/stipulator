...
- **[toolchain-skew-sampled-at-the-tree-root](toolchain-skew-sampled-at-the-tree-root.md)** — the skew sample reads the tree root, not the target module, and a failed sample degrades instead of refusing (REQ-fresh-toolchain-skew). *Lands: cross-tool train chunk 221*
