...
- [ ] 7. Publish cross-tool contract fixtures and adapt gomutant to consume binding-surface targets and emit Stipulator advisory attachments while retaining ownership of mutation findings and measurement freshness.
