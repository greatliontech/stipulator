...
- [ ] 4. Implement backend-independent binding-surface derivation and canonical identifiers, enforce their invariants with property and anchor tests, and resolve the validation and surface-identifier gaps.
- [ ] 5. Publish authoritative valid and invalid cross-tool fixtures covering canonical IDs, mixed backends, shared requirements, empty bindings, empty reports, and malformed documents.
