...
- [ ] 2. Replace hardening protobuf report fields and the stranded kill-sheet witness type with binding-surface messages, reserving removed wire names and numbers.
...
- [ ] 5. Mirror target export over MCP while removing hardening reminder, staged-scope, and survivor-roll-up fields from its tools and results.
