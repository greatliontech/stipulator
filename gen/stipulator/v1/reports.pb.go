...
func (x *RequirementCoverage) GetWitnessSelectionBlocked() bool {
	if x != nil {
		return x.xxx_hidden_WitnessSelectionBlocked
	}
	return false
}
...
func (x *RequirementCoverage) HasWitnessSelectionBlocked() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 5)
...
func (x *RequirementCoverage) ClearWitnessSelectionBlocked() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 5)
...
type RequirementCoverage_builder struct {
	...
	Bucket  *Bucket
	Reasons []string
	// The row is red solely because its bound tests sit outside the
	// policy's witness-eligible selection: a policy-level cause restated
	// per requirement, so bounded projections can fold these rows into a
	// count behind the one result-level diagnostic instead of flooding
...
type GapReport struct {
	...
	xxx_hidden_Contradicted  bool                   `protobuf:"varint,8,opt,name=contradicted"`
	XXX_raceDetectHookData   protoimpl.RaceDetectHookData
	XXX_presence             [1]uint32
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
...
func (x *GapReport) GetContradicted() bool {
	if x != nil {
...
func (x *GapReport) SetContradicted(v bool) {
...
func (x *GapReport) HasContradicted() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 7)
...
func (x *GapReport) ClearContradicted() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 7)
...
type GapReport_builder struct {
	...
	StaleConsent *bool
	// The manual condition declares the letter contradicted by design
	// until it fires (its own row class in every summary).
	Contradicted *bool
}
...
func (x *CoverageSummary) GetGapsContradicted() int32 {
	if x != nil {
...
func (x *CoverageSummary) HasGapsContradicted() bool {
	if x == nil {
		return false
	}
	return protoimpl.X.Present(&(x.XXX_presence[0]), 12)
...
func (x *CoverageSummary) ClearGapsContradicted() {
	protoimpl.X.ClearPresent(&(x.XXX_presence[0]), 12)
...
const file_stipulator_v1_reports_proto_rawDesc = "" +
	...
	"\rscope_blocked\x18\a \x01(\bR\fscopeBlocked\"\x8a\x02\n" +
	"\tGapReport\x12\x12\n" +
	"\x04path\x18\x01 \x01(\tR\x04path\x12%\n" +
